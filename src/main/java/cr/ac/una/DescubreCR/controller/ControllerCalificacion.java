...
public String listar(Model modelo) throws SQLException {
    ...
    public String consulta_eliminar() {
        return "califi/consulta_eliminar";
    }

    @PostMapping("/eliminar")
    public String eliminar(@RequestParam("id_calificacion") int idCalificacion) throws SQLException {
        ServiciosCalificacion.eliminarCalificacion(idCalificacion);
        return "redirect:/calificaciones/listar";
    }

    @GetMapping("/consulta_actualizar")
    public String consulta_actualizar(Model modelo) {
        modelo.addAttribute("calificacion", new Calificacion());
        return "califi/consulta_actualizar";
    }
