 ...
 */
@Entity
@Table(name="tb_comentariosLugar")
public class ComentarioLugar {
    ...
    public ComentarioLugar(String codigoComentario, String contenido, LocalDate fecha, int cantidadLikes, int cantidadDislikes, boolean visibilidad, String etiquetas, Usuario usuario, Lugar lugar) {
